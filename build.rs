...
fn os_build() -> Result<()> {
    ...
    let bindings: Bindings = builder
        ...
        .allowlist_var("RTE_ETH_DEV_RX_OFFLOAD_TCP_CKSUM")
        .allowlist_var("RTE_ETH_DEV_RX_OFFLOAD_UDP_CKSUM")
        .allowlist_var("RTE_ETH_DEV_TX_OFFLOAD_TCP_CKSUM")
        .allowlist_var("RTE_ETH_DEV_TX_OFFLOAD_UDP_CKSUM")
